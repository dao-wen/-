...
<div class="header">
	...
	<ul>
		...
		<li><a href="javascript:void(0)" class="logout">退出登入</a></li>
	</ul>
	</div>
</div>
<div class="left">
	...
	<div class="menux">
		...
		<ul>
			...
			<li>
				<a href="" url="${basePath }teacher?method=list" title="老师管理">
				<i class="fa fa-caret-right"></i>
				老师管理
				</a>
			</li>
			<li>
				<a href="" url="${basePath }course?method=list" title="课程管理">
				<i class="fa fa-caret-right"></i>
				课程管理
				</a>
			</li>
			<li>
				<a href="" url="${basePath }scquery?method=query_range" title="分数区间统计">
				<i class="fa fa-caret-right"></i>
				分数区间统计
				</a>
			</li>
			<li>
				<a href="" url="${basePath }scquery?method=query_jgl" title="及格率">
				<i class="fa fa-caret-right"></i>
				及格率
				</a>
			</li>
		...
		<ul>
			<li>
				<a href="" url="${basePath }sc?method=tc" title="评分管理"></a>
				<i class="fa fa-fa-caret-right"></i>
				评分管理
			</li>
			<li>
				<a href="" url="${basePath }scquery?method=query_teacher" title="查询统计"></a>
				<i class="fa fa-fa-caret-right"></i>
				查询统计
			</li>
		...
		<ul>
			<li>
				<a href="" url="${basePath }sc?method=select" title="选课"></a>
				<i class="fa fa-fa-caret-right"></i>
				选课
			</li>
			<li>
				<a href="" url="${basePath }student?method=detail" title="查询统计"></a>
				<i class="fa fa-fa-caret-right"></i>
				查询统计
			</li>
		</ul>
