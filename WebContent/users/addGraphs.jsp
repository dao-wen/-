			...
			<div class="box">
				<div class="box_1">
					<div class="userCenterBox boxCenterList clearfix" style="_height: 1%;">
						...
						<div class="blank"></div>
						<form action="index/addGraphs.action" name="myform" method="post">
							<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
								...
								<tr>
									<td colspan="2" align="center" bgcolor="#FFFFFF">
										<iframe width="100%" height="460px" frameBorder="0" src="pics/createPics.action?gno=${gno }"></iframe>
									</td>
								</tr>
								<tr>
									<td colspan="2" align="center" bgcolor="#FFFFFF">
									<input type="hidden" name="graphsid" value="${gno }" id="graphsid">
									<input type="submit" class="bnt_blue_1" style="border: none;" value="确认提交" /></td>
								</tr>
							</table>
						</form>
