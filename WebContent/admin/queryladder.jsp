...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>成长阶梯管理 <span class="c-gray en">&gt;</span> 成长阶梯查询 <a
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="4">成长阶梯查询</th>
				</tr>
				<tr class="text-c">
			...
			<c:forEach items="${ladderList}" var="ladder">
				<tr class="text-c">
					<td class="center">${ladder.username}</td>
					<td class="center">${ladder.title}</td>
					<td class="center">${ladder.addtime}</td>
				</tr>
			</c:forEach>
		</table>
		<div class="cl pd-5 mt-20"></div>
		<div class="text-c">
			<form action="ladder/queryLadderByCond.action" name="myform" method="post">
