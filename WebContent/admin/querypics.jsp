...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>图片文件管理 <span class="c-gray en">&gt;</span> 图片文件查询 <a
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="4">图片文件查询</th>
				</tr>
				<tr class="text-c">
					<th class="center">标题</th>
					<th class="center">相册</th>
				</tr>
			</thead>
			<c:forEach items="${picsList}" var="pics">
				<tr class="text-c">
					<td class="center">${pics.picname}</td>
					<td class="center">${pics.title}</td>
				</tr>
			</c:forEach>
		</table>
		<div class="cl pd-5 mt-20"></div>
		<div class="text-c">
			<form action="pics/queryPicsByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select">
						<option value="picname">按标题查询</option>
						<option value="image">按图片查询</option>
						<option value="graphsid">按相册查询</option>
