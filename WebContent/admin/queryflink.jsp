...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>友情链接管理 <span class="c-gray en">&gt;</span> 友情链接查询 <a
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="5">友情链接查询</th>
				</tr>
				<tr class="text-c">
			...
			<c:forEach items="${flinkList}" var="flink">
				<tr class="text-c">
					<td class="center">${flink.flinkname}</td>
					<td class="center">${flink.url}</td>
					<td class="center">${flink.addtime}</td>
					<td class="center">${flink.memo}</td>
				</tr>
			</c:forEach>
		</table>
		<div class="cl pd-5 mt-20"></div>
		<div class="text-c">
			<form action="flink/queryFlinkByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select">
						<option value="flinkname">按名称查询</option>
						<option value="url">按地址查询</option>
