...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>家庭相册管理 <span class="c-gray en">&gt;</span> 家庭相册查询 <a
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="7">家庭相册查询</th>
				</tr>
				<tr class="text-c">
			...
			<c:forEach items="${graphsList}" var="graphs">
				<tr class="text-c">
					<td class="center">${graphs.username}</td>
					<td class="center">${graphs.title}</td>
					<td class="center">${graphs.addtime}</td>
					<td class="center">${graphs.hits}</td>
				</tr>
			</c:forEach>
		</table>
		<div class="cl pd-5 mt-20"></div>
		<div class="text-c">
			<form action="graphs/queryGraphsByCond.action" name="myform" method="post">
