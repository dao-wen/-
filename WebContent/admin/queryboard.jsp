...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>交流版块管理 <span class="c-gray en">&gt;</span> 交流版块查询 <a
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="4">交流版块查询</th>
				</tr>
				<tr class="text-c">
					<th class="center">板块名称</th>
			...
			<c:forEach items="${boardList}" var="board">
				<tr class="text-c">
					<td class="center">${board.boardname}</td>
					<td class="center">${board.addtime}</td>
					<td class="center">${board.memo}</td>
				</tr>
			</c:forEach>
		</table>
		<div class="cl pd-5 mt-20"></div>
		<div class="text-c">
			<form action="board/queryBoardByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select">
						<option value="boardname">按板块名称查询</option>
