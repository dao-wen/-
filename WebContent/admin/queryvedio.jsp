...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>成长MV管理 <span class="c-gray en">&gt;</span> 成长MV查询 <a
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="8">成长MV查询</th>
				</tr>
				<tr class="text-c">
			...
			<c:forEach items="${vedioList}" var="vedio">
				<tr class="text-c">
					<td class="center">${vedio.username}</td>
		...
		<div class="text-c">
			<form action="vedio/queryVedioByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select">
						...
						<option value="fileurl">按文件查询</option>
